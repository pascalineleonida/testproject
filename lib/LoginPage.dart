...
import 'package:testproject/singUppage.dart';
        ...
        children: [
          ...
          Padding(
            ...
            child: Container(
              width: 200,
                height: 50,
                child: ElevatedButton(onPressed: (){}, child: Text('Login',style: TextStyle(fontWeight: FontWeight.bold),))),
          ),
          Text('Voulez-vous creer un compte?'),
